...
(function () {
  ...
  const STEP_SCRIPTS = {
    es: {
      ...
      3: `¡Excelente, paso 3! ✂️ Aquí agregas los servicios que ofreces — nombre, precio y descripción. Esto es lo que tu bot le dirá a tus clientes cuando pregunten qué haces. Debes llenar AL MENOS UN servicio para poder continuar. Si solo vendes productos sin servicios, usa el botón "Omitir" que aparece debajo del botón Siguiente. ¡Cuando termines, pasa a la siguiente hoja! 😊`,
      ...
      6: `¡Ya casi, paso 6! 📞 Esta sección tiene tres partes: primero tu información de contacto — teléfono, WhatsApp, email y dirección. Segundo, los días y horarios que trabajas — MUY importante para que tu bot sepa cuándo estás disponible. Y tercero, al final verás el Sistema de Citas por WhatsApp — si lo activas, tus clientes podrán agendar citas directamente en tu bot y tú recibes un mensaje de WhatsApp al instante con todos los detalles. ¡Un paso más y terminamos!`,
    ...
    en: {
      ...
      3: `Excellent, step 3! ✂️ Here you add the services you offer — name, price, and description. This is what your bot will tell clients when they ask what you do. You must fill in AT LEAST ONE service to continue. If you only sell products with no services, use the "Skip" button below the Next button. When you finish, move to the next page! 😊`,
      ...
      6: `Almost there, step 6! 📞 This section has three parts: first, your contact info — phone, WhatsApp, email, and address. Second, your working days and hours — VERY important so your bot knows when you're available. And third, at the bottom you'll see the WhatsApp Appointment System — if you turn it on, your clients can book appointments directly in your bot and you instantly get a WhatsApp message with all the details. One more step and we're done!`,
