...
(function () {
  ...
  const STEP_SCRIPTS = {
    es: {
      ...
      3: `¡Súper, paso 3! Aquí listas tus servicios — nombre, precio y una buena descripción de cada uno. Eso es exactamente lo que tu bot le va a decir a tus clientes cuando pregunten. Puedes agregar hasta 8, o los generamos con IA en el paso final.`,
    ...
    en: {
      ...
      3: `Awesome, step 3! List your services here — name, price, and a good description for each. That's exactly what your bot will tell clients when they ask. You can add up to 8, or we can generate them with AI in the last step.`,
